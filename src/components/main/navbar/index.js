    ...
    return (
        <nav className=' p-3 bg-gray-100 dark:bg-slate-700 shadow dark:text-white'>
            <div className='flex flex-wrap justify-between items-center container mx-auto'>
                <div className='flex'>
                    <div className='flex fill-slate-300 items-center'><img src={ReactLogo} width={50} alt="logo" /></div>
                    <svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="50px"  viewBox="0 0 207 124" version="1.1">
                        <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                            <g id="Black-Next.js" transform="translate(-247.000000, -138.000000)" className='dark:fill-white fill-black' fillRule="nonzero">
